<template>
  <div class="flex w-full flex-col items-center justify-center gap-4" role="tabpanel">
    ...
    <div class="flex items-center justify-center gap-5">
      <MailPanelsButtonsClear :show-dialog="showClearDialog" @toggle-dialog="(val) => (showClearDialog = val)" @clear-text="isClearText = true" @click="deselectOthers('clear')" />
      <MailPanelsButtonsCopy :show-dialog="showCopyDialog" @toggle-dialog="(val) => (showCopyDialog = val)" :output-text="outputText" @click="deselectOthers('copy')" />
      <MailPanelsButtonsSave
      ...
      />
      <MailPanelsButtonsShare :show-dialog="showShareDialog" @toggle-dialog="(val) => (showShareDialog = val)" :saved-mail="savedMail" @click="deselectOthers('share')" />
    </div>
