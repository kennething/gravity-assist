<template>
  <div id="menu" class="flex w-[50rem] flex-col items-start justify-center gap-2 rounded-2xl bg-white dark:bg-neutral-800 p-10" @click.stop>
