<template>
  ...
  <form class="flex w-full flex-col items-center justify-center gap-2" @submit.prevent="link">
    <div class="mt-4 flex w-full flex-col items-start justify-center gap-1 md:flex-row md:items-center md:gap-4">
      ...
      <div class="fo-input-group flex grow rounded-full bg-body transition duration-500 dark:border-neutral-400 dark:bg-neutral-800 dark:hover:border-neutral-400">
        <span class="fo-input-group-text shrink-0">
          <img class="size-5 select-none transition duration-500 dark:invert" src="/ui/person.svg" aria-hidden="true" />
        </span>
        <input
          v-model="userId"
          type="text"
    ...
    <div class="flex w-full flex-col items-start justify-center gap-1 md:flex-row md:items-center md:gap-4">
      ...
      <div class="fo-input-group flex grow rounded-full bg-body transition duration-500 dark:border-neutral-400 dark:bg-neutral-800 dark:hover:border-neutral-400">
        <span class="fo-input-group-text shrink-0">
          <img class="size-5 select-none transition duration-500 dark:invert" src="/ui/key.svg" aria-hidden="true" />
        </span>
        <input
          v-model="accessToken"
          type="text"
    ...
    <button
      ...
      class="flex h-9 w-9 select-none items-center justify-center rounded-full border border-neutral-300 p-0 transition duration-500 lg:w-36 lg:justify-start lg:p-2 lg:px-4 dark:border-neutral-700"
    ...
    >
      <img v-if="!linkLoading" class="size-5 select-none transition duration-500 dark:invert" src="/ui/link.svg" aria-hidden="true" />
