  ...
  >
    <div class="flex w-full flex-col items-center justify-center" v-if="ship">
      ...
      <div class="mt-3 flex w-full flex-col items-center justify-center gap-2">
        ...
        <button class="fo-btn w-full text-black transition duration-500 dark:border-neutral-600 dark:bg-neutral-600 dark:text-white dark:hover:border-neutral-700 dark:hover:bg-neutral-700">
          Add to Blueprints
        </button>
      </div>
    </div>
