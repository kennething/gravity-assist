<template>
  ...
  >
    <div v-if="ship" class="flex w-full flex-col items-center justify-center">
    ...
    <div v-else class="flex h-56 w-full items-center justify-center text-xl font-medium transition duration-500">Select a ship to view more details!</div>
  </div>
</template>
...
const emit = defineEmits<{ bestPath: [AllShip] }>();
