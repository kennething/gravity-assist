<template>
  ...
  >
    <span class="fo-input-group-text">
      <img class="size-5 shrink-0 select-none transition duration-500 dark:invert" src="/ui/search.svg" aria-hidden="true" />
    </span>
    <input
      v-model="search"
      type="text"
      class="search-input fo-input grow select-none rounded-e-full text-left text-black transition duration-500 placeholder:transition placeholder:duration-500 dark:text-white dark:placeholder:text-neutral-300"
      placeholder="Search"
    />
